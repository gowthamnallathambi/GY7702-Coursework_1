...
#libraries for relavent script

rm(list=ls())                       # To clear environment
#install.packages("palmerpenguins") # Question 2.1: Install palmerpenguins packages
library(tidyverse)                  # Load tidyverse library in relevant script 
library(palmerpenguins)             # Load palmerpenguins library in relevant script
...
#Minimum, median and maximum proportion between bill length and bill depth by species
...
#Question 3.1
#Import covid data using dplyr

```{r Create the complete table}
...
```{r The development of new cases}
